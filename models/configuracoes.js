...
async function saveUserName(event) {
    ...
    if (!user)
        return showErrorToast("Acesso negado", "Usuário não autenticado");
...
async function updateUserInfoConfig() {
    ...
    if (user) {
        const userEmail = user.email;
        console.log(
            "updateUserInfoConfig - Carregando dados do usuário:",
            user.id
        );
        ...
        try {
            ...
            if (error) {
                console.error(
                    "updateUserInfoConfig - Erro ao buscar dados:",
                    error
                );
            } else {
            ...
            console.warn(
                "updateUserInfoConfig - Erro lendo tabela usuarios:",
                e
            );
        }
        ...
        if (el) {
            ...
            console.log(
                "updateUserInfoConfig - Nome exibido na tela:",
                userName
            );
        }
