...
(function initAccessibility() {
            ...
            Object.values(Chart.instances).forEach((chart) => {
                if (chart && chart.options && chart.options.plugins) {
                    ...
                    if (chart.options.scales) {
                        Object.keys(chart.options.scales).forEach(
                            (scaleKey) => {
    ...
    function setupEventListeners() {
        ...
        // Botão toggle da barra flutuante
        ...
        document.addEventListener("click", function (e) {
            ...
            if (bar && !bar.contains(e.target) && isMenuOpen) {
                isMenuOpen = false;
                if (controls) {
                    controls.classList.remove("open");
                }
        ...
        // Fechar menu ao clicar num botão (opcional, deixa a escolha aberta)
        const btns = document.querySelectorAll(".accessibility-btn");
        btns.forEach((btn) => {
            btn.addEventListener("click", function () {
                // Menu permanece aberto para permitir múltiplas ações
                // Se quiser fechar após clicar, descomente a próxima linha
                // isMenuOpen = false;
                // controls.classList.remove("open");
            });
        });
